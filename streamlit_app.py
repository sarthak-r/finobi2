...
def calculate_balance(super_bal, annual_contribution, retirement_age, roi, inflation_rate, income_replacement_ratio, life_expectancy):
    years = np.arange(retirement_age, life_expectancy + 1)
...
years, balance = calculate_balance(super_bal, annual_contribution, retirement_age, roi, inflation_rate, income_replacement_ratio, life_expectancy)
